                            ...
                            <div class="relative h-full overflow-hidden bg-cover rounded-xl py-8" style="background-image: url('../../../public/assets/img/wp2.jpg')">
                                ...
                                <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                                    <div class="flex justify-between mb-4">
                                        <h5 class="mb-6 font-bold text-white">Titre <?php echo $ticket['title']; ?> </h5>
                                    </div>
                                    <p class="text-white">Description <?php echo $ticket['description']; ?> </p>
                                    <div class="flex justify-between">
                                        <p>Statut : <?php echo $ticket['statut']; ?> </p>
