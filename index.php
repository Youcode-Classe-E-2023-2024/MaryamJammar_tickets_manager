      ...
      <div class="max-w-lg px-4 pb-24 mx-auto text-left md:max-w-none md:text-center">
        <div class='text-center space-x-4'>
          <p class="text-lg text-gray-600 mb-12">
            Bienvenue sur notre plateforme ! Connectez-vous ou inscrivez-vous pour profiter de tous nos services.
          </p>
          <a href="./app/view/User/login.php">
          ...
          <a href="./app/view/User/register.php">
